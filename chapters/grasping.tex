...
While already very involved for anything but very simple mechanisms, such a model only captures a very small slice of realistic grasps \td{Nikolaus, I have no idea what you mean with this first sentence, please rephrase}.
...
\begin{figure}
    ...
    \td{Nikolaus, it would be nice to show both normal forces and tangential forces due to friction in this fig, so that you can show $F_\mathrm{n}$ and $F_\mathrm{t}$. Again, fine if you don't want to do it. EDIT: upon further reading, I see you show it in \cref{fig:coulombfriction}}}
\end{figure}
