...
随着激光距离测量过程的快速化，这种激光器可以与旋转镜组合以扫描较大的区域，称为“激光测距扫描仪”\“激光测距扫描仪”。这样的系统已被组合成由多达64个扫描激光器组成的包装，在驾驶时提供围绕汽车的深度图，例如。然而，也可以用相位改变信号调制投影图像，这是早期“飞行时间”摄像机的操作原理，但这并不能准确描述它们的操作。
