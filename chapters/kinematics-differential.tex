...
\end{equation}
which is the case because both robot's and world coordinate system share the same z-axis in this example. 
...
\end{equation}
a rotation around the z-axis. Maybe unsurprisingly, this is simply the well-known rotation around the z-axis, which applies equally to velocities as to poses.
