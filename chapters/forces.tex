...
\begin{figure}[!t]
    ...
    \caption{Velocity (top) and force (bottom) manipulability ellipsoids for a 2 DoF planar arm ($n=m=2$). In this simple $2\times2$ case, the ellipsoids collapse to simple ellipses (whose major axes are drawn in a dotted line). \td{add figure, finish captions} }\label{fig:manipulability}
\end{figure}
