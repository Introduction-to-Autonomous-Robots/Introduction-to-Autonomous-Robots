...
\begin{enumerate}
\item Derive an expression for $p(marker\|reading)$ assuming that you have an estimate of the probability to correctly identify a marker $p(correct)$ and the probability $p(marker)$ of being underneath a specific marker. 
