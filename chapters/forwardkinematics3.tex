...
\item Consider a tri-cycle with two independent standard wheels in the rear and the stearable front-wheel. Chose a suitable coordinate system and use $\theta$ as the steering wheel angle and wheel-speed $\dot{\omega}$. Provide forward and inverse kinematics. 
\end{enumerate}
\normalsize