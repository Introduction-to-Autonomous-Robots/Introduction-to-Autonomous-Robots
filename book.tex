...
Finally, this book has been written with an interactive class room in mind. Individual chapters, and later in the book single sections, are reduced to a few ``take home lessons'' that can be articulated together with the students during the last five minutes of class. The text is also scattered with boxed questions that can be elaborated by the students in five-minute long break-out sessions. 
